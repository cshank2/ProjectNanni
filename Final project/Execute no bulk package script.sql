...
begin
    ...
    dom_batch.pkg_job_api.g_sp_insrt_trckg_id
    (
    i_job_dfntn_id  =>  1234,
    ...
    dom_batch.pkg_acct_info_export_no_bulk.g_sp_acct_info_stg(l_v_stg_job_trckg_id);

    dbms_output.put_line ('Retrieving export job tracking id. Time '||to_char(sysdate, 'MM/DD/YYYY HH24:MI:SS'));
    dom_batch.pkg_job_api.g_sp_rtrv_trckg_id
    (
    i_job_dfntn_id  =>  1235,
    ...
    dom_batch.pkg_acct_info_export_no_bulk.g_sp_acct_info_xport(l_v_xport_job_trckg_id);  
