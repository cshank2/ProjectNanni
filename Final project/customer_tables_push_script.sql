create table dom_batch.t_cust_acct
(
    cust_acct_id  number,
...
create sequence dom_batch.sq_cust_acct
    start with 1
    increment by 1
    noorder;

create table dom_batch.t_cust_acct_hist
(
...
create sequence dom_batch.sq_cust_acct_hist
    start with 1
    increment by 1
    noorder;

create table dom_batch.t_cust_addr
(
    cust_addr_id   number,
    cust_acct_id   number constraint fk_cad_cai references dom_batch.t_cust_acct (cust_acct_id),
...
create sequence dom_batch.sq_cust_addr
    start with 1
    increment by 1
    noorder;

create table dom_batch.t_cust_addr_hist
(
...
create sequence dom_batch.sq_cust_addr_hist
    start with 1
    increment by 1
    noorder;

create table dom_batch.t_cust_trnsctn
(
    cust_trnsctn_id number,
    cust_acct_id    number constraint fk_ct_cai references dom_batch.t_cust_acct (cust_acct_id),
...
create sequence dom_batch.sq_cust_trnsctn
    start with 1
    increment by 1
    noorder;

create table dom_batch.t_cust_trnsctn_hist
(
    cust_trnsctn_hist_id number,
    cust_trnsctn_id      number,
    cust_acct_id         number constraint fk_cai references dom_batch.t_cust_acct (cust_acct_id),
    trnsctn_code         varchar2 (5),
    trnsctn_amt          number (20, 2),
    trnsctn_date         date,
    trnsctn_desc         varchar2 (100),
...
create sequence dom_batch.sq_cust_trnsctn_hist
    start with 1
    increment by 1
    noorder;
