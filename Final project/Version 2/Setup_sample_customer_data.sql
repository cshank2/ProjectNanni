/**************************************************************************************************
**    Script to create sample customer data to test the job framework 
**
***************************************************************************************************/
...
begin
    ...
    for i in 1 .. 1000000 loop
        ...
        values
            (
                job_frmwrk.sq_cust_acct.nextval,
                'first_name' || i,
                'last_name' || i,
                '4109175595',
                '4107042000',
        ...
        values
            (
                job_frmwrk.sq_cust_addr.nextval,
                l_v_cust_acct_id,
                'address_line_1 st',
                'apt',
                'MD',
    ...
    loop
        ...
        forall i in 1 .. l_v_cur_var.count
            ...
            values
                (
                    job_frmwrk.sq_cust_trnsctn.nextval,
